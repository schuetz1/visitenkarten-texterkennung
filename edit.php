    ...
    <div class="w-container">
        <div class="w-row">
            <div class="w-col w-col-9">
                <h1>Der Kontakt wurde bearbeitet</h1>
            </div>
        </div>
        <div class="container">
            <?php
            include("Helper/DatabaseHelper.php");
            include("Helper/PostVariablesKontaktHelper.php");
            ...
            if ($conn->query($sql) === TRUE) {
                echo "<br><br><br><strong>Datenbank:</strong> Die Daten wurden erfolgreich in die Datenbank eingetragen <br><br> ";
            } else {
            ...
            <br><br>
            <div>
                <a href="index.php">Zurück zum Telefonbuch</a><br><br>
